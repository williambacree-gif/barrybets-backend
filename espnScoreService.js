...
class ESPNScoreService {
  ...
  static normalizeTeamName(espnName) {
    ...
    var map = {
      ...
      'Villanova':'Villanova',"St. John's":"St. John's","St. John's (NY)":"St. John's","St John's":"St. John's",
      ...
      'Cal Baptist':'Cal Baptist','California Baptist':'Cal Baptist','CBU':'Cal Baptist','CA Baptist':'Cal Baptist',
      ...
      'Miami Ohio':'Miami (OH)','Miami (OH)':'Miami (OH)','Miami OH':'Miami (OH)',
      'SMU':'SMU','UMBC':'UMBC',
